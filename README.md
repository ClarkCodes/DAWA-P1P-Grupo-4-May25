# Portal de Promoción de Eventos Universitarios
...
<div align="center" justify="center">
  ...
  <a href="https://angular.dev/"><img src="https://img.shields.io/badge/Angular-21-0F0F11.svg?longCache=true&style=plastic&logo=angular&color=#0F0F11" alt="Angular shield image"></a>
...
## Como probarlo
Para ejecutar el proyecto en un entorno de desarrollo, se debe realizar lo siguiente:
1. Clonar el proyecto en tu equipo local.
2. Tener instalado Node.js 23 o superior.
3. Tener instalado pnpm, se recomienda la version 10.14.
4. Abrir el proyecto con tu editor de codigo favorito y/o abrir dos terminales en la ubicacion del proyecto en local.
5. Instala las dependencias del proyecto, ya que no se distribuye la carpeta de node_modules, en una terminal ejecuta el comando
```terminal
pnpm install
```   
6. En una terminal ejecuta la dependecia de json server para que puedas ver datos de prueba, ejecuta el comando
```terminal
pnpx json-server -w public/json/db.json
```
7. En la otra terminal levanta el proyecto de angular, ejecuta el comando
```terminal
pnpm start
```
o
...
ng serve
```
El json server deberia correr en el puerto 3000 y al levantar el proyecto de angular debe indicarte la url en la cual se esta ejecutando el proyecto en local, presiona Ctrl + Click sobre el link para abrirla en un navegador web, o bien copia la url y abrela manualmente en un navegador web, y con esto ya deberias estar viendo la aplicacion web de angular con datos de prueba, pruedes iniciar sesion como estudiante, como facultad, como club o como administrador, puedes revisar el archivo public/json/db.json para ver los datos de prueba, en la seccion de Cuentas se encuentran cuentas de prueba de diferentes tipos.

## Gracias por visitar
Y bueno... me gustaria agregar un poco más contenido a este Readme, este es un proyecto de práctica, pero probablemente agregue más contenido cuando haya podido iterarlo y evolucionarlo más y esté un poco más maduro, tratare de ir mejorandolo con el tiempo, gracias por verlo, un abrazo, hasta pronto y por supuesto...
